...
def create_optimizer(model, args):
    ...
    Args:
        ...
        args (argparse.Namespace): Parsed command-line arguments containing optimizer information.
...
def create_scheduler(optimizer, args):
    ...
    Args:
        ...
        args (argparse.Namespace): Parsed command-line arguments containing scheduler information.

    Returns:
        torch.optim.lr_scheduler._LRScheduler: The created learning rate scheduler.

    Raises:
        ValueError: If the specified scheduler is unsupported.
    """
    if args.scheduler == "step_lr":
        scheduler = lr_scheduler.StepLR(optimizer, step_size=args.scheduler_params.get("step_size", 10),
        ...
        scheduler = lr_scheduler.CosineAnnealingLR(optimizer, T_max=args.scheduler_params.get("T_max", 10))
        ...
        scheduler = lr_scheduler.CosineAnnealingWarmRestarts(optimizer, T_0, T_mult)
    else:
